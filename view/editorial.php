        ...
        <form method="POST" id="frmAgregarEditorial" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #F9F9F9;">
                    <h6 class="modal-title" style="color: black; font-weight: bold;">Agregar Editorial</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <label for="txtNombreEditorial" class="titulos_formularios">Nombre de Editorial: </label>
                    <input type="text" class="form-control from-control-user" maxlength="80" name="txtNombreEditorial" id="txtNombreEditorial" required placeholder="Ingrese el nombre de la editorial..." />
...
<div id="modalModificarEditorial" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <form method="POST" id="frmModificarEditorial" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #F9F9F9;">
                    <h6 class="modal-title" style="color: black; font-weight: bold;">Modificar Editorial</h6>
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" name="txtNombreEditorialu" id="txtNombreEditorialu" />

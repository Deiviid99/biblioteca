        ...
        <form method="POST" id="frmAgregarUsuario" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #F9F9F9;">
                    <h6 class="modal-title" style="color: black; font-weight: bold;">Agregar Usuario</h6>
...
<div id="modalModificarUsuario" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form method="POST" id="frmModificarUsuario" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #F9F9F9;">
                    <h6 class="modal-title" style="color: black; font-weight: bold;">Modificar Usuario</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">

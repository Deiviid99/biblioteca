        ...
        <form method="POST" id="frmAgregarAutor" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Agregar Autor</h6>
...
<div id="modalModificarAutor" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <form method="POST" id="frmModificarAutor" enctype="multipart/form-data">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Modificar Autor</h6>
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" name="txtNombreAutoru" id="txtNombreAutoru" placeholder="Ingrese los nombres del autor..." />
                    ...
                    <input type="text" class="form-control" name="txtApellidoAutoru" id="txtApellidoAutoru" placeholder="Ingrese los apellidos del autor..." />
